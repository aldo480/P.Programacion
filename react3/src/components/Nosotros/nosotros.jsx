...
const Nosotros = () => (
    <main class={style.contenedor}>
        <h3 class={style.centrarTexto}>Sobre Nosotros</h3>

        <div class={style.sobreNosotros}>
            <div class={style.sobreNosotrosImagen}>
                <img src={img} alt="imagen nosotros" />
            </div>

            <div class={style.sobreNosotrosTexto}>
